...
// function Supa(props: BoardProps) {
...
//           (payload: any) => {
//             setTextData(payload.new.Editor);
//           }
//         )
//         .subscribe();
//     }
...
//     if (room.id) setTextData(room.Editor);
//   }, [room.Editor]);
...
//         const writingData = Text;
//         const base64ImageData = canvas.toDataURL("image/png");
//         updateRoomDrawing(room?.id, base64ImageData, writingData);
//       }, 1000);
//     };

//     // Simulate fetching data
//     setTimeout(() => {
//       setTextData("This text came from an API.");
//     }, 1000);
//    [];

  
//     if (textData) {
//       console.log('Text data loaded and displayed.');
//       ctx.font = "bold 48px serif";
//       ctx.strokeText("Hello world", 50, 100);
//       // Perform actions related to the loaded text
//     }
//    [textData]; // Runs when textData changes
...
//     });
//     // eslint-disable-next-line react-hooks/exhaustive-deps
//   }, [room?.id, textData, room.Editor, canvas]);
...
//     // Define the event handler using const
...
//           <canvas className='w-full h-full' id='board'>
            
//           </canvas>
//           <div>
//           {textData ? <p>{textData}</p> : <p>Loading text...</p>}
//         </div>
