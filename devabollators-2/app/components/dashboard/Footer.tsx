  ...
  return (
    <><section>
      <h1 className='text-slate font-semibold text-blue-400'>
          ...
          Ask for Mentor assist by sending an email to <b><u>learn.quickly.coding@gmail.com</u></b> 
      </h1>
      <br></br>
      <div className="text-slate-600 font-semibold text-blue-400 mb-4" style={{ fontSize: '12px', textAlign: 'right' }}>
